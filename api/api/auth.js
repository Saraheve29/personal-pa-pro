export default async function handler(req, res) {
  ...
  const CLIENT_ID = process.env.GOOGLE_CLIENT_ID || client_id || "1077821534253-poq3v4hcdj57dfgauhu0pd8nsseuq8ie.apps.googleusercontent.com";
  const CLIENT_SECRET = process.env.GOOGLE_CLIENT_SECRET || client_secret || "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";
